...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['site-owner', 'content-moderator', 'anime-reviewer', 'registered-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Anime', path: '/anime', entity: 'anime', service: AccessServiceEnum.PROJECT, icon: FiFilm },
    {
      name: 'Moderations',
      path: '/moderations',
      entity: 'moderation',
    ...
    { name: 'Watchlists', path: '/watchlists', entity: 'watchlist', service: AccessServiceEnum.PROJECT, icon: FiEye },
