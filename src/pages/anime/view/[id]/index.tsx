...
import { getAnimeById } from 'apiSdk/anime';
import { AnimeInterface } from 'interfaces/anime';
import { ReviewListPage } from 'pages/reviews';
import { WatchlistListPage } from 'pages/watchlists';

function AnimeViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('anime', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/anime/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Episodes" text={data?.episodes} />
