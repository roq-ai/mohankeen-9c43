...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`mohankeen`}</title>

        <meta
          name="description"
          content="Discover your next favorite anime with mohankeen - your trusted destination for comprehensive and unbiased anime ratings."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1519638399535-1b036603ac77?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhbmltZXxlbnwwfHx8fDE2OTUzNDg2MjZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover your next favorite anime with mohankeen - your trusted destination for comprehensive and unbiased anime ratings.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Site Owner" type="site-owner" abilities={appConfig.ownerAbilities} />
