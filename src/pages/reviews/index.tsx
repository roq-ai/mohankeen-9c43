...
export function ReviewListPage(props: ReviewListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getReviews({
        relations: ['anime', 'user', 'moderation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('moderation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'moderation',
          header: 'Moderation',
          accessorKey: 'moderation',
          cell: ({ row: { original: record } }: any) => record?._count?.moderation,
        }
      : null,
