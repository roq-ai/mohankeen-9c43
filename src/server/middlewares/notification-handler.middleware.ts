...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Anime Review.create': {
    roles: ['site-owner', 'content-moderator'],
    key: 'Anime Review ID',
    tenantPath: [],
    userPath: [],
  },
  'Content Moderation.delete': {
    roles: ['site-owner', 'anime-reviewer'],
    key: 'Content ID',
    tenantPath: [],
    userPath: [],
  },
  'Comment.create': {
    roles: ['site-owner', 'content-moderator', 'anime-reviewer'],
    key: 'Comment ID',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['site-owner', 'content-moderator', 'anime-reviewer', 'registered-user'];
